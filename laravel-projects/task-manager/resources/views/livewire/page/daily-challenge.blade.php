    ...
    @else
        <form wire:submit.prevent="saveEntry">
            ...
            <div class="mb-4">
                ...
                <input type="number" min="0.25" step="0.25" wire:model.defer="hoursCoded" class="mt-1 block w-28 rounded-md border-gray-300 dark:border-gray-700 shadow-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-900 dark:text-white" />
