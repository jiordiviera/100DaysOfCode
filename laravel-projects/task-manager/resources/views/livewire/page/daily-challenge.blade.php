<div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
  ...
  @if ($todayEntry && $todayEntry->completed)
    <div
      class="mb-4 p-3 bg-blue-50 dark:bg-blue-900 text-blue-800 dark:text-blue-200 rounded"
    >
    ...
    <form wire:submit.prevent="saveEntry">
      <div class="mb-4">
        ...
        <textarea
          ...
          rows="3"
          class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-900 dark:text-white"
        ></textarea>
        @error("description")
      ...
      <div class="mb-4">
        ...
        <select
          wire:model.defer="projectsWorkedOn"
          multiple
          class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-900 dark:text-white"
        >
      ...
      <div class="mb-4">
        ...
        <input
          ...
          min="0.25"
          step="0.25"
          wire:model.defer="hoursCoded"
          class="mt-1 block w-28 rounded-md border-gray-300 dark:border-gray-700 shadow-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-900 dark:text-white"
        />
        @error("hoursCoded")
          <span class="text-red-500 text-xs">{{ $message }}</span>
        @enderror
      ...
      <div class="mb-4">
        ...
        <textarea
          wire:model.defer="challengesFaced"
          rows="2"
          class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-900 dark:text-white"
        ></textarea>
      </div>
