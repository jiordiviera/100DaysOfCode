<div>
    ...
    <section class="relative py-16 bg-primary">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center">
            ...
            <p class="mt-4 text-lg leading-6 text-blue-100 max-w-2xl text-center">
                Rejoignez des milliers de développeurs qui transforment leur vie en codant chaque jour. Inscrivez-vous
                gratuitement et démarrez votre parcours des 100 jours de code.
            </p>
            <div class="mt-8 flex justify-center">
                ...
                <div class="ml-3 inline-flex">
                    <a href="{{ route('login') }}"
                       class="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-blue-800 bg-opacity-60 hover:bg-opacity-70">
                        Se connecter
                    </a>
                </div>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-10 grid gap-8 lg:grid-cols-3">
                <div class="bg-gray-50 dark:bg-gray-800 rounded-lg shadow-md p-6">
                    ...
                    <p class="text-gray-600 dark:text-gray-300 italic mb-4">"Cette application a complètement transformé
                        ma façon d'aborder le défi des 100 jours de code. Grâce à elle, je reste organisé et motivé
                        chaque jour."</p>
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            <p class="text-sm font-medium text-gray-900 dark:text-white">Sophie Lambert</p>
                            <p class="text-sm text-gray-500 dark:text-gray-400">Développeuse Web</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 dark:bg-gray-800 rounded-lg shadow-md p-6">
                    ...
                    <p class="text-gray-600 dark:text-gray-300 italic mb-4">"J'ai essayé plusieurs fois le défi des 100
                        jours sans succès. Avec cette plateforme, j'ai enfin réussi à atteindre mon objectif. La gestion
                        de projets est incroyable!"</p>
                    <div class="flex items-center">
                        <div
                            class="h-10 w-10 rounded-full bg-gradient-to-r from-blue-400 to-indigo-500 flex items-center justify-center text-white font-bold">
                            TD
                        ...
                        <div class="ml-3">
                            <p class="text-sm font-medium text-gray-900 dark:text-white">Thomas Dubois</p>
                            <p class="text-sm text-gray-500 dark:text-gray-400">Étudiant en informatique</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 dark:bg-gray-800 rounded-lg shadow-md p-6">
                    ...
                    <p class="text-gray-600 dark:text-gray-300 italic mb-4">"La fonction de collaboration est géniale!
                        Notre équipe utilise cette plateforme pour coordonner nos projets et suivre notre progression
                        collective pendant le défi."</p>
                    <div class="flex items-center">
                        <div
                            class="h-10 w-10 rounded-full bg-gradient-to-r from-blue-400 to-indigo-500 flex items-center justify-center text-white font-bold">
                            ML
                        ...
                        <div class="ml-3">
                            <p class="text-sm font-medium text-gray-900 dark:text-white">Marie Leclerc</p>
