<div>
      ...
      <div class="lg:grid lg:grid-cols-12 lg:gap-8">
        ...
        >
          <h1>
            ...
            >
              ...
              <span
                class="block bg-clip-text text-transparent bg-gradient-to-r from-primary to-primary/80 pb-1"
              >
                100 Days of Code
              </span>
            </span>
        ...
        >
          <div class="relative mx-auto w-full rounded-lg shadow-lg lg:max-w-md">
            <div
              class="relative block w-full bg-white dark:bg-gray-800 rounded-lg overflow-hidden"
            >
              <img
                class="w-full"
              ...
              <div class="absolute inset-0 flex items-center justify-center">
                <svg
                  class="h-20 w-20 text-primary/90"
                  fill="currentColor"
                  viewBox="0 0 84 84"
                >
                  <circle
  ...
  <section class="relative py-16 bg-primary">
    <div
      class="absolute inset-0 bg-gradient-to-r from-primary/90 to-primary opacity-90"
    ></div>
    <div
