<div class="max-w-2xl mx-auto py-8">
  <h1
    class="text-2xl font-bold mb-6 text-center text-indigo-700 dark:text-indigo-300"
  >
    Tâches du projet :
  ...
  <div class="space-y-4">
    @forelse ($project->tasks as $task)
      <div
        class="bg-white dark:bg-gray-800 shadow rounded-lg p-4 flex flex-col gap-2"
      >
        ...
        @if ($editTaskId === $task->id)
          <form wire:submit.prevent="updateTask" class="flex gap-2 mt-2">
            ...
            <button
              ...
              class="px-2 py-1 bg-gray-400 text-white rounded hover:bg-gray-500 text-xs"
            >
              Annuler
            </button>
            @error("editTaskName")
  ...
  <a
    ...
    class="inline-block mt-8 px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700"
  >
    Retour aux projets
  </a>
</div>
