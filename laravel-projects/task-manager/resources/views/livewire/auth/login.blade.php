  ...
  <div class="p-4 sm:p-7">
    <div class="text-center">
      ...
      <p class="mt-2 text-sm text-gray-600 dark:text-neutral-400">
        ...
        <a href="../examples/html/signup.html">
          Sign up here
        </a>
      </p>
    </div>
      ...
      <form wire:submit.prevent="submit">
        <div class="grid gap-y-4">
          ...
          <div>
            ...
            <div class="relative">
              <input type="email" id="email" wire:model="email" required aria-describedby="email-error">
            </div>
          ...
          <div>
            ...
            <div class="relative">
              <input type="password" id="password" wire:model="password" required aria-describedby="password-error">
                @error('password')<div class="absolute inset-y-0 end-0 pointer-events-none pe-3">
